...
lyr_Projetdeconteneurisation_3.set('fieldLabels', {'Site': 'header label - always visible', 'Commune': 'hidden field', 'Maitrise d\'Ouvrage': 'hidden field', 'Latitude': 'hidden field', 'Longitude': 'hidden field', 'Statut': 'header label - always visible', 'Soutien Bureau d\'étude': 'header label - always visible', 'Type de conteneurs': 'hidden field', 'Nb OM': 'header label - always visible', 'Nb MM': 'inline label - always visible', 'Nb V': 'inline label - always visible', });
