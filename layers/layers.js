...
lyr_FondESRI_0.setVisible(true);lyr_Communes_1.setVisible(true);lyr_GrandAnnecy_2.setVisible(true);lyr_Projetdeconteneurisation_3.setVisible(true);
var layersList = [lyr_FondESRI_0,group_Territoire,lyr_Projetdeconteneurisation_3];
